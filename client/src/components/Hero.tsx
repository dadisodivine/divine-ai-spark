        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="animate-fade-in text-left lg:text-left">
            ...
            <p className="text-base md:text-lg text-gray-600 dark:text-gray-400 mb-8 max-w-2xl leading-relaxed animate-delayed-fade-in-2">
              ...
              Having co-developed <a href="https://www.permitprep.co.zw/" target="_blank" rel="noopener noreferrer" className="text-primary font-semibold hover:text-primary/80 underline decoration-primary/60 hover:decoration-primary transition-all duration-300 hover:scale-105 inline-block">PermitPrep</a> and the open source tool Gitmate which has over a 100 users as of now
            </p>
